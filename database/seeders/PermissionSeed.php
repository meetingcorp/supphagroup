...
class PermissionSeed extends Seeder
{
    ...
    public function run()
    {
        ...
        'managebanner','managepermission','managerole','managewebsite',
        'manageproject', 'manageservice', 'managepdpa', 'manageinbox',
    ]);

        $role1 = Role::create(['name' => 'admin']);
        $role1->syncPermissions(['manageuser', 'managenews', 'managebanner', 'managewebsite', 'manageinbox']);
