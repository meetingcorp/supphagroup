(function ($) {
    ...
    $.fn.hummingbird.ThreeStateLogic = function (tree, doubleMode, allVariables, checkDoubles, checkDisabled) {
        var options = $.extend({}, $.fn.hummingbird.defaults);
        tree.find('input:checkbox').on('click', function (e) {
            ...
            // mycustom
            if (options.nodeParent) {
                $(this).parent("label").parent().parents("li").children("label").children("input:checkbox").prop("checked", true);
            }
