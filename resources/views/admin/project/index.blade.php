...
@php $pagename = 'จัดการข้อมูลโครงการ' @endphp
...
@section('content')
    ...
    <div class="row">
        <div class="col">
            <div class="card">
                <div class="card-body">
                    <a href="{{ route('project.create') }}" class="btn btn-info mb-4"><i class="fa-solid fa-circle-plus pr-2"></i>เพิ่มข้อมูล</a>
                    <hr>
                    <div class="mt-4">
...
@push('js')
    <script>
        ...
        function publish(ele) {
            ...
            $.ajax({
                type: 'get',
                url: '{{ url('admin/project/publish') }}/' + ele.id,
                data: frmdata,
        ...
        function sort(ele) {
            ...
            $.ajax({
                type: 'get',
                url: '{{ url('admin/project/sort') }}/' + ele.id,
                data: frmdata,
                success: function(response) {
                    if (response.status === true) {
                        Swal.fire({
